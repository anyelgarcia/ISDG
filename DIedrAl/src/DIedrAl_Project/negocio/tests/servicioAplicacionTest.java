 ...
 * 
		...
		// PRUEBA: LOS PACIENTES SE A�ADEN CORRECTAMENTE. FILTRO FUNCIONA
		// ----------------------------------------------------------------------------------
		...
		// PRUEBA: LOS USUARIOS SE A�ADEN CORRECTAMENTE. FILTRO FUNCIONA
		// ----------------------------------------------------------------------------------
		try {
			// Usuario a añadir
		...
		// PRUEBA: comprobar que paciente y terapeuta est�n ligados.
		// ----------------------------------------------------------------------------------
		try {
