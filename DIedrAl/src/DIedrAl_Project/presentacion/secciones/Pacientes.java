...
public class Pacientes extends ColorPanel{   
	...
	private class PantallaPaciente extends JFrame{
		...
		private void initGUI(){
			...
			jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(Calendario.DIAS));
			jComboBox6.setModel(new javax.swing.DefaultComboBoxModel<>(Calendario.MESES));
			jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(Calendario.AÑOS));
