...
/**
 * Esta clase lleva la gestiÛn de las vistas de los recursos. En el constructor se dibuja la secciÛn de Recursos del Men˙ Principal y se pone a la espera para 
 * aÒadir, eliminar, editar o buscar recursos.
...
public class Recursos extends ColorPanel{
	...
	/**
	 * Clase que gestiona la ventana que aparece al darle al bot√≥n -A√±adir- en la secci√≥n -Recursos- del M√©n√∫ Principal
	 * @author Diedral_Group
	 *
	 */
	...
	private class PantallaRecurso extends JFrame{
		...
		/**
		 * FunciÛn que se ejecuta al darle a guardar en la ventana de adici√≥n de recursos. Se rellena un objeto recurso y es pasado al controlador.
		 * */
