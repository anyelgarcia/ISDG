...
/**
 * Pantalla para acceder al sistema en modo usuario o en modo administrador.
...
public class Login extends JFrame{
    ...
    /**
     * Acceso modo usuario. Se recoge el contenido de los campos y se lanza la aplicación si
     * el usuario es correcto (está en el sistema y la contraseña es la adecuada).
     * @param evt
     */
    ...
    /**
     * Acceso modo administrador. Se lanza una pantalla para introducir la contraseña de administrador
     * del sistema.
     * @param evt
     */
